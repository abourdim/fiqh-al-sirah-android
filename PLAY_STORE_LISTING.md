# Play Store listing — Fiqh al-Sirah (فقه السيرة)
...
- **Package name**: `org.workshopdiy.fiqhalsirah`
...
```
كتاب "فقه السيرة" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
📜 فقه السيرة — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "فقه السيرة" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "فقه السيرة" — الشيخ محمد الغزالي
...
### App name
```
Fiqh al-Sirah — Fiqh Al-Sirah
```

### Short description
```
"Fiqh Al-Sirah" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Fiqh Al-Sirah" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Fiqh Al-Sirah" — Sheikh Mohammed al-Ghazali
...
### Short description
```
« Fiqh Al-Sirah » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Fiqh Al-Sirah » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Fiqh Al-Sirah » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Fiqh al-Sirah
Last updated: 2026-04-26

The Fiqh al-Sirah app does not collect, store, transmit, or share any personal
